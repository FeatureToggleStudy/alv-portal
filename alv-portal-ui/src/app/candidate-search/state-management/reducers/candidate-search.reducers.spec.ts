...
describe('candidateSearchReducer', () => {
    ...
    const occupationCode: OccupationCode = { type: 'AVAM', value: '68913', mapping: { type: 'BFS', value: '33302009' } };
    const localityItem: LocalityItem = { regionCode: 'ZH12', cantonCode: 'ZH', communalCode: '261' };
    ...
    it('FILTER APPLIED : it should update resultList and totalCount', () => {
        // GIVEN
        const action = new candidateActions.FilterAppliedAction( {page: candidateProfilePageOne, totalCount: 100 });
    ...
    it('CANDIDATE_PROFILE_DETAIL_LOADED : should update selectedCandidateProfile and visitedCandidates', () => {
        ...
        const visitedCandidatesTwo = { [selectedCandidateProfileOne.id]: true , [selectedCandidateProfileTwo.id]: true };
