...
/**
 * The guard need to redirect the user from the legacy urls (hash-based strategy) to the
 * urls we use
 */
export class LegacyUrlStrategyRedirectionGuard implements CanActivate {
  ...
  canActivate(next: ActivatedRouteSnapshot, state: RouterStateSnapshot): false {
